...
function refresh_combo_count(count) {
    ...
    $('#emote_combo span.count').addClass('animate_animated animate_pulse');
    $('#emote_combo span.count').on(
        'webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend',
        function() {
            $(this).removeClass('animate_animated animate_pulse');
        }
    );
    $('#emote_combo img').addClass('animate_animated animate_pulse');
    $('#emote_combo img').on(
        'webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend',
        function() {
            $(this).removeClass('animate_animated animate_pulse');
...
function refresh_emote_combo({ emote, count }) {
    ...
    if (emote_combo.length === 0) {
        ...
        new_notification.addClass('animate_animated animate_bounceInLeft');
        ...
        close_down_combo = setTimeout(function() {
            new_notification.addClass('animate_animated animate_bounceOutLeft ended');
        }, 4000);
    } else {
        clearTimeout(close_down_combo);
        close_down_combo = setTimeout(function() {
            emote_combo.addClass('animate_animated animate_bounceOutLeft ended');
        }, 3000);
    }
