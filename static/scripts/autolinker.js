(function(root, factory) {
  ...
  Autolinker.AnchorTagBuilder = Autolinker.Util.extend(Object, {
    ...
    createCssClass: function(matchType) {
      ...
      if (!className) return "";
      else return className + " " + className + "-" + matchType; // ex: "myLink myLink-url", "myLink myLink-email", "myLink myLink-phone", "myLink myLink-twitter", or "myLink myLink-hashtag"
    },
    ...
    doTruncate: function(anchorText) {
      return Autolinker.Util.ellipsis(
        anchorText,
  ...
  Autolinker.matchParser.MatchParser = Autolinker.Util.extend(Object, {
    ...
    replace: function(text, replaceFn, contextObj) {
      ...
      return text.replace(this.matcherRegex, function(
        matchStr,
        $1,
        $2,
        $3,
        ...
        var matchDescObj = me.processCandidateMatch(
          matchStr,
          $1,
          $2,
          $3,
    ...
    processCandidateMatch: function(
      matchStr,
      twitterMatch,
      twitterHandlePrefixWhitespaceChar,
      twitterHandle,
      emailAddressMatch,
      urlMatch,
      protocolUrlMatch,
      ...
      if (
        ...
        !this.matchValidator.isValidMatch(
          urlMatch,
          protocolUrlMatch,
      ...
      if (emailAddressMatch) {
        ...
        if (protocolRelativeMatch) {
          var charBeforeMatch =
            protocolRelativeMatch.match(
              this.charBeforeProtocolRelMatchRegex
            )[1] || "";
  ...
  Autolinker.MatchValidator = Autolinker.Util.extend(Object, {
    ...
    isInvalidProtocolRelativeMatch: function(protocolRelativeMatch) {
      return (
        !!protocolRelativeMatch &&
        this.invalidProtocolRelMatchRegex.test(protocolRelativeMatch)
      );
    }
  });
  /*global Autolinker */
