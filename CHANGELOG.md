...
- Minor: Added `moderation_action` setting to the maxmsglength module. This allows bot admins to choose whether to delete or timeout an offending user's paragraph.
