...
- Minor: Added `disable_warnings` & `moderation_action` settings to the Massping module. This allows moderators to disable warning timeouts and and choose whether to delete or timeout an offending user's message. (#2089)
