...
- Bugfix: Actually apply CSRF protection to web forms. (#2875)
- Bugfix: Provide better error handling if command creation failed, or ran into any non-fatal errors. (#2888)
...
- Dev: Add codecov's test result analytics. (#2859)
