...
- Minor: Added `disable_warnings` & `moderation_action` settings to the Massping module. Not only does this enable bot admins to disable warning timeouts, but it also allows them to choose whether to delete or timeout an offending user's message. (#2089)
