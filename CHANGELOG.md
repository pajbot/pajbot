...
- Minor: Added custom message options to the LastFM module.
- Minor: Added customizable cooldowns to the LastFM module.
- Minor: Added an online only option to the LastFM module.
