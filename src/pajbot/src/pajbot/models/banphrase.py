...
class Banphrase(Base):
    ...
    operator: Mapped[str] = mapped_column(
        Text, default="contains", server_default="contains"
    )
...
class BanphraseManager:
    ...
    def check_message(
        self, message: str, user: Optional[User]
    ) -> Union[Banphrase, Literal[False]]:
    ...
    def find_match(
        self, message: str, banphrase_id: Optional[str] = None
    ) -> Optional[Banphrase]:
        match = None
