...
def init(config_path: str) -> None:
    ...
    import pajbot.utils
    import pajbot_webapp.common
    import pajbot_webapp.routes
    ...
    from pajbot_webapp.models import errors
    from pajbot_webapp.utils import download_logo, download_sub_badge
    ...
    pajbot_webapp.routes.admin.init(app)
    pajbot_webapp.routes.api.init(app)
    pajbot_webapp.routes.base.init(app)

    # Make a CSRF exemption for the /api/v1/banphrases/test endpoint
    csrf.exempt("pajbot_webapp.routes.api.banphrases.banphrases_test")

    pajbot_webapp.common.filters.init(app)
    pajbot_webapp.common.assets.init(app)
    pajbot_webapp.common.menu.init(app)

    app.register_blueprint(pajbot_webapp.routes.clr.page)

    errors.init(app, config)
    pajbot_webapp.routes.clr.config = config
