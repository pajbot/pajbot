...
def init(bp: Blueprint) -> None:
    ...
    def commands() -> ResponseReturnValue:
        commands = pajbot_webapp.utils.get_cached_commands()
    ...
    def command_get(raw_command_id) -> ResponseReturnValue:
        ...
        if command_id:
            command = find(
                ...
                pajbot_webapp.utils.get_cached_commands(),
            )
        else:
            command = find(
    ...
    @pajbot_webapp.utils.requires_level(500)
