...
class TwitchHelixAPI(BaseTwitchAPI):
    ...
    def _fetch_subscribers_page(self, broadcaster_id: str, authorization, first: Optional[str] = None, after_pagination_cursor=None):
    ...
    def fetch_all_subscribers(self, broadcaster_id, authorization):
        ...
        subscriber_ids = self._fetch_all_pages(self._fetch_subscribers_page, broadcaster_id, authorization, first="100")
