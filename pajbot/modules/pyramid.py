...
class PyramidModule(BaseModule):
    ...
    SETTINGS = [ModuleSetting(
                ...
                type='text',
                required=True,
                placeholder='{user} just finished a {width}-width {emote} pyramid! That\'s pretty neat KKona //',
                default='{user} just finished a {width}-width {emote} pyramid! That\'s pretty neat KKona //',
                constraints={
                    'min_str_len': 10,
                    'max_str_len': 400,
                }),
                ...
                type='text',
                required=True,
                placeholder='{user} just finished a {width}-width {emote} pyramid! Good job!!! PogChamp //',
                default='{user} just finished a {width}-width {emote} pyramid! Good job!!! PogChamp //',
                constraints={
                    'min_str_len': 10,
                    'max_str_len': 400,
                }),
                ...
                type='text',
                required=True,
                placeholder='{user} just finished a {width}-width {emote} pyramid! Now that\'s what I call pyramid-farming Kappa // PogChamp //',
                default='{user} just finished a {width}-width {emote} pyramid! Now that\'s what I call pyramid-farming Kappa // PogChamp //',
                constraints={
                    'min_str_len': 10,
                    'max_str_len': 400,
                }),
                ...
                type='text',
                required=True,
                placeholder='{user} just finished a {width}-width {emote} pyramid! Wow, I can\'t even fit this pyramid in my memory bank MrDestructoid //',
                default='{user} just finished a {width}-width {emote} pyramid! Wow, I can\'t even fit this pyramid in my memory bank MrDestructoid //',
                constraints={
                    'min_str_len': 10,
                    'max_str_len': 400,
                }),
                ...
                type='text',
                required=True,
                placeholder='{user} just finished a {width}-width {emote} pyramid! BUFFER OVERFLOW WutFace //',
                default='{user} just finished a {width}-width {emote} pyramid! BUFFER OVERFLOW WutFace //',
                constraints={
                    'min_str_len': 10,
                    'max_str_len': 400,
                }),
