                    ...
                    if good:
                        ...
                        if len_diff > 0:
                            ...
                            if cur_len == 1:
                                ...
                                if peak_length > 2:
                                    if peak_length < 5:
                                        self.bot.safe_say(self.get_phrase("message_5", **arguments))
                                    elif peak_length < 7:
                                        self.bot.safe_say(self.get_phrase("message_7", **arguments))
                                    elif peak_length < 15:
                                        self.bot.safe_say(self.get_phrase("message_15", **arguments))
                                    elif peak_length < 25:
                                        self.bot.safe_say(self.get_phrase("message_25", **arguments))
                                    else:
                                        self.bot.safe_say(self.get_phrase("message_else", **arguments))
                                self.data = []
                                self.going_down = False
                    else:
                        self.data = []
