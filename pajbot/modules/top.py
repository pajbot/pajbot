...
class TopModule(BaseModule):
    ...
    SETTINGS = [
        ...
        ModuleSetting(
            ...
            label=f"Enable the {bot.prefix}topchatters command (most messages)",
            type="boolean",
            required=True,
            default=False,
        ),
        ModuleSetting(
            ...
            label=f"Enable the {bot.prefix}topwatchers command (most time spent watching the stream)",
            type="boolean",
            required=True,
            default=False,
        ),
        ModuleSetting(
            ...
            label=f"Enable the {bot.prefix}topoffline command (most time spent in offline chat)",
            type="boolean",
            required=True,
            default=False,
        ),
        ModuleSetting(
            ...
            label=f"Enable the {bot.prefix}toppoints command (most points)",
            type="boolean",
            required=True,
            default=False,
        ),
