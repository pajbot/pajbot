...
class PlaysoundModule(BaseModule):
    ...
    def add_playsound_command(self, bot, source, message, **rest):
        ...
        if options is False or name is False or link is False or link is None:
            bot.whisper(
                source,
                f"Invalid usage. Correct syntax: {bot.prefix}add playsound <name> <link> "
        ...
        with DBManager.create_session_scope() as session:
            ...
            if count > 0:
                bot.whisper(
                    source,
                    f"A Playsound with that name already exists. Use {bot.prefix}edit playsound "
                    + f"or {bot.prefix}remove playsound to edit or delete it.",
                )
                return
    ...
    def edit_playsound_command(self, bot, source, message, **rest):
        ...
        if options is False or name is False or link is False:
            bot.whisper(
                source,
                f"Invalid usage. Correct syntax: {bot.prefix}edit playsound <name> [link] "
                + "[--volume 0-100] [--cooldown 60/none] [--enabled/--disabled]",
            )
            return
        ...
        with DBManager.create_session_scope() as session:
            ...
            if playsound is None:
                bot.whisper(
                    ...
                    f"{bot.prefix}add playsound <name> <link> [options].",
                )
                return
    ...
    def remove_playsound_command(bot, source, message, **rest):
        ...
        if not playsound_name:
            bot.whisper(source, f"Invalid usage. Correct syntax: {bot.prefix}remove playsound <name>")
            return
    ...
    def debug_playsound_command(bot, source, message, **rest):
        ...
        # check for empty string
        if not playsound_name:
            bot.whisper(source, f"Invalid usage. Correct syntax: {bot.prefix}debug playsound <name>")
            return
                ...
                "playsound": Command.raw_command(
                    ...
                    examples=[
                        CommandExample(
                            ...
                            chat=f"user:{bot.prefix}add playsound doot https://i.nuuls.com/Bb4aX.mp3\n"
                        ...
                        CommandExample(
                            ...
                            chat=f"user:{bot.prefix}add playsound doot https://i.nuuls.com/Bb4aX.mp3 --volume 50\n"
                            "bot>user:Successfully created your playsound",
                        ...
                        CommandExample(
                            ...
                            chat=f"user:{bot.prefix}add playsound doot https://i.nuuls.com/Bb4aX.mp3 --cooldown 60\n"
                            "bot>user:Successfully created your playsound",
                        ...
                        CommandExample(
                            ...
                            chat=f"user:{bot.prefix}add playsound doot https://i.nuuls.com/Bb4aX.mp3 --disabled\n"
                            "bot>user:Successfully created your playsound",
                ...
                "playsound": Command.raw_command(
                    ...
                    examples=[
                        CommandExample(
                            ...
                            chat=f"user:{bot.prefix}edit playsound doot https://i.nuuls.com/Bb4aX.mp3\n"
                        ...
                        CommandExample(
                            ...
                            chat=f"user:{bot.prefix}edit playsound doot --volume 50\n"
                            "bot>user:Successfully edited your playsound",
                        ...
                        CommandExample(
                            ...
                            chat=f"user:{bot.prefix}edit playsound doot --cooldown 60\n"
                            "bot>user:Successfully edited your playsound",
                        ...
                        CommandExample(
                            ...
                            chat=f"user:{bot.prefix}edit playsound doot --disabled\n"
                            "bot>user:Successfully edited your playsound",
                        ...
                        CommandExample(
                            ...
                            chat=f"user:{bot.prefix}edit playsound doot --enabled\n"
                            "bot>user:Successfully edited your playsound",
                ...
                "playsound": Command.raw_command(
                    ...
                    examples=[
                        CommandExample(
                            ...
                            chat=f"user:{bot.prefix}remove playsound doot\n"
                ...
                "playsound": Command.raw_command(
                    ...
                    examples=[
                        CommandExample(
                            ...
                            chat=f"user:{bot.prefix}debug playsound doot\n"
