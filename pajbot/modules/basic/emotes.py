...
class EmotesModule(BaseModule):
    ...
    SETTINGS = [
        ...
        ModuleSetting(
            ...
            label="Custom Response for the ffzemotes command | Available arguments: {source}",
            type="text",
            required=False,
            placeholder="{source}, FFZ emotes can be found here: https://www.frankerfacez.com/channel/pajlada",
            default="",
            constraints={"max_str_len": 400},
        ),
        ModuleSetting(
        ...
        ModuleSetting(
            ...
            label="Custom Response for the bttvemotes command | Available arguments: {source}",
            type="text",
            required=False,
            placeholder="{source}, BTTV emotes can be found here: https://betterttv.com/users/550daf6562e6bd0027aedb5e",
            default="",
            constraints={"max_str_len": 400},
        ),
    ]
