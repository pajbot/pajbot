def up(cursor, context):
    ...
    CREATE TABLE command_data (
        ...
        added_by INT DEFAULT NULL,
        edited_by INT DEFAULT NULL,
        last_date_used TIMESTAMP WITH TIME ZONE DEFAULT NULL
    )
    """
    )
    ...
    CREATE TABLE link_data (
        ...
        first_linked TIMESTAMP WITH TIME ZONE DEFAULT NULL,
        last_linked TIMESTAMP WITH TIME ZONE DEFAULT NULL
    )
    """
    )
    ...
    CREATE TABLE pleblist_song (
        ...
        date_played TIMESTAMP WITH TIME ZONE DEFAULT NULL,
    ...
    CREATE TABLE stream (
        id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
        title TEXT NOT NULL,
        stream_start TIMESTAMP WITH TIME ZONE NOT NULL,
        stream_end TIMESTAMP WITH TIME ZONE NOT NULL,
    ...
    CREATE TABLE stream_chunk (
        ...
        chunk_end TIMESTAMP WITH TIME ZONE DEFAULT NULL,
    ...
    CREATE TABLE user_duel_stats (
        ...
        last_duel TIMESTAMP WITH TIME ZONE DEFAULT NULL,
