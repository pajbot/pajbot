...
def test_find_unique_urls() -> None:
    ...
    assert find_unique_urls("pajlada.se test http://pajlada.se") == {
        "http://pajlada.se"
    }
    ...
    assert find_unique_urls("foobar.com foobar.se"), {
        "http://foobar.com" == "http://foobar.se"
    }
    assert find_unique_urls("www.foobar.com foobar.se"), {
    ...
    assert find_unique_urls("pajlada.se/ pajlada.se"), {
    ...
    assert (
        find_unique_urls("omg this isn't chatting, this is meme-ing...my vanity")
        == set()
    )
