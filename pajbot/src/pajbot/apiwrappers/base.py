...
class BaseAPI:
    def __init__(
        self, base_url: Optional[str], redis: Optional[RedisType] = None
    ) -> None:
    ...
    def join_base_and_list(base: str, path_segments: list[Any]) -> str:
        ...
        for path_segment in path_segments:
            ...
            url = BaseAPI.join_base_and_string(
                url, BaseAPI.quote_path_param(str(path_segment))
            )
    ...
    def post(
        ...
        **request_options: Any,
        ...
        return self.request(
            "POST", endpoint, params, headers, json, **request_options
        ).json()
    ...
    def put(
        ...
        **request_options: Any,
        ...
        return self.request(
            "PUT", endpoint, params, headers, json, **request_options
        ).json()
    ...
    def delete(
        ...
        **request_options: Any,
        ...
        return self.request(
            "DELETE", endpoint, params, headers, json, **request_options
        )
