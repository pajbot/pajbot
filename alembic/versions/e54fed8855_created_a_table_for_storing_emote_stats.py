...
def upgrade():
    ...
    op.create_table('tb_emote_stats',
...
def downgrade():
    ...
    op.add_column('tb_emote', sa.Column('tm_record', mysql.INTEGER(display_width=11), autoincrement=False, nullable=True))
